...
/// "1 cookie (28 g)").
 String? get servingSize;/// The normalized numeric serving quantity from the OFF API
...
/// form. May be null for products that have no packaging data.
 String? get quantity;/// The normalized numeric quantity in g or ml (e.g. `500` for "500 ml",
/// `450` for "3 x 150 g").
///
...
/// Sourced from nutriments.energy-kcal_100g in the API response.
 ...
 double? get saltG;/// Additional nutrients beyond the six core fields, each carrying its
/// own value and unit.
///
...
/// Defaults to an empty list.
 List<ProductNutrient> get additionalNutrients;/// Epoch timestamp (milliseconds since Unix epoch) of when the product
...
/// - [ProductType.custom] — manually entered by the user.
 ProductType get productType;/// The `amount` from the first USDA foodPortion (e.g. `1.0` for a single
...
/// products, manually entered items, or when USDA has no portion data.
 double? get usdaServingAmount;/// The `measureUnit.name` from the first USDA foodPortion
...
@useResult
$Res call({
 String barcode, String name, String? brand, String? imageUrl, String? offNutritionImageUrl, String? offIngredientsImageUrl, String? offProductImageUrl, List<String>? categoriesHierarchy, String? category, String? ingredients, String? servingSize, double? servingQuantity, String? quantity, double? productQuantity, double? energyKcal, double? proteinG, double? carbsG, double? fatG, double? fiberG, double? saltG, List<ProductNutrient> additionalNutrients, int? lastSynced, String? nutriscoreGrade, String? nutriscoreNotApplicableCategory, String source, String languageCode, String? nutritionImagePath, String? ingredientsImagePath, String? productImagePath, String submissionStatus, String? pluCode, ProductType productType, double? usdaServingAmount, String? usdaServingUnit, double? usdaGramWeight
});
...
/// Create a copy of Product
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? barcode = null,Object? name = null,Object? brand = freezed,Object? imageUrl = freezed,Object? offNutritionImageUrl = freezed,Object? offIngredientsImageUrl = freezed,Object? offProductImageUrl = freezed,Object? categoriesHierarchy = freezed,Object? category = freezed,Object? ingredients = freezed,Object? servingSize = freezed,Object? servingQuantity = freezed,Object? quantity = freezed,Object? productQuantity = freezed,Object? energyKcal = freezed,Object? proteinG = freezed,Object? carbsG = freezed,Object? fatG = freezed,Object? fiberG = freezed,Object? saltG = freezed,Object? additionalNutrients = null,Object? lastSynced = freezed,Object? nutriscoreGrade = freezed,Object? nutriscoreNotApplicableCategory = freezed,Object? source = null,Object? languageCode = null,Object? nutritionImagePath = freezed,Object? ingredientsImagePath = freezed,Object? productImagePath = freezed,Object? submissionStatus = null,Object? pluCode = freezed,Object? productType = null,Object? usdaServingAmount = freezed,Object? usdaServingUnit = freezed,Object? usdaGramWeight = freezed,}) {
...
as double?,additionalNutrients: null == additionalNutrients ? _self.additionalNutrients : additionalNutrients // ignore: cast_nullable_to_non_nullable
as List<ProductNutrient>,lastSynced: freezed == lastSynced ? _self.lastSynced : lastSynced // ignore: cast_nullable_to_non_nullable
...
as ProductType,usdaServingAmount: freezed == usdaServingAmount ? _self.usdaServingAmount : usdaServingAmount // ignore: cast_nullable_to_non_nullable
as double?,usdaServingUnit: freezed == usdaServingUnit ? _self.usdaServingUnit : usdaServingUnit // ignore: cast_nullable_to_non_nullable
as String?,usdaGramWeight: freezed == usdaGramWeight ? _self.usdaGramWeight : usdaGramWeight // ignore: cast_nullable_to_non_nullable
as double?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String barcode,  String name,  String? brand,  String? imageUrl,  String? offNutritionImageUrl,  String? offIngredientsImageUrl,  String? offProductImageUrl,  List<String>? categoriesHierarchy,  String? category,  String? ingredients,  String? servingSize,  double? servingQuantity,  String? quantity,  double? productQuantity,  double? energyKcal,  double? proteinG,  double? carbsG,  double? fatG,  double? fiberG,  double? saltG,  List<ProductNutrient> additionalNutrients,  int? lastSynced,  String? nutriscoreGrade,  String? nutriscoreNotApplicableCategory,  String source,  String languageCode,  String? nutritionImagePath,  String? ingredientsImagePath,  String? productImagePath,  String submissionStatus,  String? pluCode,  ProductType productType,  double? usdaServingAmount,  String? usdaServingUnit,  double? usdaGramWeight)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Product() when $default != null:
return $default(_that.barcode,_that.name,_that.brand,_that.imageUrl,_that.offNutritionImageUrl,_that.offIngredientsImageUrl,_that.offProductImageUrl,_that.categoriesHierarchy,_that.category,_that.ingredients,_that.servingSize,_that.servingQuantity,_that.quantity,_that.productQuantity,_that.energyKcal,_that.proteinG,_that.carbsG,_that.fatG,_that.fiberG,_that.saltG,_that.additionalNutrients,_that.lastSynced,_that.nutriscoreGrade,_that.nutriscoreNotApplicableCategory,_that.source,_that.languageCode,_that.nutritionImagePath,_that.ingredientsImagePath,_that.productImagePath,_that.submissionStatus,_that.pluCode,_that.productType,_that.usdaServingAmount,_that.usdaServingUnit,_that.usdaGramWeight);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String barcode,  String name,  String? brand,  String? imageUrl,  String? offNutritionImageUrl,  String? offIngredientsImageUrl,  String? offProductImageUrl,  List<String>? categoriesHierarchy,  String? category,  String? ingredients,  String? servingSize,  double? servingQuantity,  String? quantity,  double? productQuantity,  double? energyKcal,  double? proteinG,  double? carbsG,  double? fatG,  double? fiberG,  double? saltG,  List<ProductNutrient> additionalNutrients,  int? lastSynced,  String? nutriscoreGrade,  String? nutriscoreNotApplicableCategory,  String source,  String languageCode,  String? nutritionImagePath,  String? ingredientsImagePath,  String? productImagePath,  String submissionStatus,  String? pluCode,  ProductType productType,  double? usdaServingAmount,  String? usdaServingUnit,  double? usdaGramWeight)  $default,) {final _that = this;
switch (_that) {
case _Product():
return $default(_that.barcode,_that.name,_that.brand,_that.imageUrl,_that.offNutritionImageUrl,_that.offIngredientsImageUrl,_that.offProductImageUrl,_that.categoriesHierarchy,_that.category,_that.ingredients,_that.servingSize,_that.servingQuantity,_that.quantity,_that.productQuantity,_that.energyKcal,_that.proteinG,_that.carbsG,_that.fatG,_that.fiberG,_that.saltG,_that.additionalNutrients,_that.lastSynced,_that.nutriscoreGrade,_that.nutriscoreNotApplicableCategory,_that.source,_that.languageCode,_that.nutritionImagePath,_that.ingredientsImagePath,_that.productImagePath,_that.submissionStatus,_that.pluCode,_that.productType,_that.usdaServingAmount,_that.usdaServingUnit,_that.usdaGramWeight);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String barcode,  String name,  String? brand,  String? imageUrl,  String? offNutritionImageUrl,  String? offIngredientsImageUrl,  String? offProductImageUrl,  List<String>? categoriesHierarchy,  String? category,  String? ingredients,  String? servingSize,  double? servingQuantity,  String? quantity,  double? productQuantity,  double? energyKcal,  double? proteinG,  double? carbsG,  double? fatG,  double? fiberG,  double? saltG,  List<ProductNutrient> additionalNutrients,  int? lastSynced,  String? nutriscoreGrade,  String? nutriscoreNotApplicableCategory,  String source,  String languageCode,  String? nutritionImagePath,  String? ingredientsImagePath,  String? productImagePath,  String submissionStatus,  String? pluCode,  ProductType productType,  double? usdaServingAmount,  String? usdaServingUnit,  double? usdaGramWeight)?  $default,) {final _that = this;
switch (_that) {
case _Product() when $default != null:
return $default(_that.barcode,_that.name,_that.brand,_that.imageUrl,_that.offNutritionImageUrl,_that.offIngredientsImageUrl,_that.offProductImageUrl,_that.categoriesHierarchy,_that.category,_that.ingredients,_that.servingSize,_that.servingQuantity,_that.quantity,_that.productQuantity,_that.energyKcal,_that.proteinG,_that.carbsG,_that.fatG,_that.fiberG,_that.saltG,_that.additionalNutrients,_that.lastSynced,_that.nutriscoreGrade,_that.nutriscoreNotApplicableCategory,_that.source,_that.languageCode,_that.nutritionImagePath,_that.ingredientsImagePath,_that.productImagePath,_that.submissionStatus,_that.pluCode,_that.productType,_that.usdaServingAmount,_that.usdaServingUnit,_that.usdaGramWeight);case _:
  return null;
...
class _Product implements Product {
  const _Product({required this.barcode, required this.name, this.brand, this.imageUrl, this.offNutritionImageUrl, this.offIngredientsImageUrl, this.offProductImageUrl, final  List<String>? categoriesHierarchy, this.category, this.ingredients, this.servingSize, this.servingQuantity, this.quantity, this.productQuantity, this.energyKcal, this.proteinG, this.carbsG, this.fatG, this.fiberG, this.saltG, final  List<ProductNutrient> additionalNutrients = const <ProductNutrient>[], this.lastSynced, this.nutriscoreGrade, this.nutriscoreNotApplicableCategory, this.source = 'api', this.languageCode = 'en', this.nutritionImagePath, this.ingredientsImagePath, this.productImagePath, this.submissionStatus = productSubmissionNotSubmitted, this.pluCode, this.productType = ProductType.barcoded, this.usdaServingAmount, this.usdaServingUnit, this.usdaGramWeight}): _categoriesHierarchy = categoriesHierarchy,_additionalNutrients = additionalNutrients;
...
/// conversion back to grams happens when submitting to Open Food Facts.
/// Defaults to an empty list.
 final  List<ProductNutrient> _additionalNutrients;
/// Additional nutrients beyond the six core fields, each carrying its
/// own value and unit.
///
/// These are the non-core contributors (vitamins, minerals, fats,
...
/// conversion back to grams happens when submitting to Open Food Facts.
/// Defaults to an empty list.
@override@JsonKey() List<ProductNutrient> get additionalNutrients {
  if (_additionalNutrients is EqualUnmodifiableListView) return _additionalNutrients;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_additionalNutrients);
}
...
/// Only meaningful for produce items fetched from USDA. Null for OFF
/// products, manually entered items, or when USDA has no portion data.
@override final  double? usdaServingAmount;
...
/// Only meaningful for produce items fetched from USDA. Null for OFF
/// products, manually entered items, or when USDA has no portion data.
@override final  double? usdaGramWeight;
...
as double?,fiberG: freezed == fiberG ? _self.fiberG : fiberG // ignore: cast_nullable_to_non_nullable
as double?,saltG: freezed == saltG ? _self.saltG : saltG // ignore: cast_nullable_to_non_nullable
as double?,additionalNutrients: null == additionalNutrients ? _self._additionalNutrients : additionalNutrients // ignore: cast_nullable_to_non_nullable
as List<ProductNutrient>,lastSynced: freezed == lastSynced ? _self.lastSynced : lastSynced // ignore: cast_nullable_to_non_nullable
as int?,nutriscoreGrade: freezed == nutriscoreGrade ? _self.nutriscoreGrade : nutriscoreGrade // ignore: cast_nullable_to_non_nullable
as String?,nutriscoreNotApplicableCategory: freezed == nutriscoreNotApplicableCategory ? _self.nutriscoreNotApplicableCategory : nutriscoreNotApplicableCategory // ignore: cast_nullable_to_non_nullable
as String?,source: null == source ? _self.source : source // ignore: cast_nullable_to_non_nullable
