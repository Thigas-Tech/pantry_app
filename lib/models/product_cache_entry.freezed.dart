...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,barcode,name,createdAt,lastRefreshedAt,nextRefreshAt,brand,category,const DeepCollectionEquality().hash(categoriesHierarchy),ingredients,servingSize,quantity,productQuantity,energyKcal,proteinG,carbsG,fatG,fiberG,saltG,nutriscoreGrade,imageUrl,offNutritionImageUrl,offIngredientsImageUrl,offProductImageUrl,languageCode,schemaVersion,usdaServingAmount,usdaServingUnit,usdaGramWeight]);
...
class _ProductCacheEntry extends ProductCacheEntry {
  const _ProductCacheEntry({required this.barcode, required this.name, required this.createdAt, required this.lastRefreshedAt, required this.nextRefreshAt, @JsonKey(includeIfNull: false) this.brand, @JsonKey(includeIfNull: false) this.category, @JsonKey(includeIfNull: false) final  List<String>? categoriesHierarchy, @JsonKey(includeIfNull: false) this.ingredients, @JsonKey(includeIfNull: false) this.servingSize, @JsonKey(includeIfNull: false) this.quantity, @JsonKey(includeIfNull: false) this.productQuantity, @JsonKey(includeIfNull: false) this.energyKcal, @JsonKey(includeIfNull: false) this.proteinG, @JsonKey(includeIfNull: false) this.carbsG, @JsonKey(includeIfNull: false) this.fatG, @JsonKey(includeIfNull: false) this.fiberG, @JsonKey(includeIfNull: false) this.saltG, @JsonKey(includeIfNull: false) this.nutriscoreGrade, @JsonKey(includeIfNull: false) this.imageUrl, @JsonKey(includeIfNull: false) this.offNutritionImageUrl, @JsonKey(includeIfNull: false) this.offIngredientsImageUrl, @JsonKey(includeIfNull: false) this.offProductImageUrl, this.languageCode = 'en', this.schemaVersion = 1, @JsonKey(includeIfNull: false) this.usdaServingAmount, @JsonKey(includeIfNull: false) this.usdaServingUnit, @JsonKey(includeIfNull: false) this.usdaGramWeight}): _categoriesHierarchy = categoriesHierarchy,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,barcode,name,createdAt,lastRefreshedAt,nextRefreshAt,brand,category,const DeepCollectionEquality().hash(_categoriesHierarchy),ingredients,servingSize,quantity,productQuantity,energyKcal,proteinG,carbsG,fatG,fiberG,saltG,nutriscoreGrade,imageUrl,offNutritionImageUrl,offIngredientsImageUrl,offProductImageUrl,languageCode,schemaVersion,usdaServingAmount,usdaServingUnit,usdaGramWeight]);
