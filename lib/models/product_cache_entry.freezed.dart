...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,barcode,name,createdAt,lastRefreshedAt,nextRefreshAt,brand,category,const DeepCollectionEquality().hash(categoriesHierarchy),ingredients,servingSize,energyKcal,proteinG,carbsG,fatG,fiberG,saltG,nutriscoreGrade,imageUrl,offNutritionImageUrl,offIngredientsImageUrl,offProductImageUrl,languageCode,schemaVersion]);

@override
String toString() {
  return 'ProductCacheEntry(barcode: $barcode, name: $name, createdAt: $createdAt, lastRefreshedAt: $lastRefreshedAt, nextRefreshAt: $nextRefreshAt, brand: $brand, category: $category, categoriesHierarchy: $categoriesHierarchy, ingredients: $ingredients, servingSize: $servingSize, energyKcal: $energyKcal, proteinG: $proteinG, carbsG: $carbsG, fatG: $fatG, fiberG: $fiberG, saltG: $saltG, nutriscoreGrade: $nutriscoreGrade, imageUrl: $imageUrl, offNutritionImageUrl: $offNutritionImageUrl, offIngredientsImageUrl: $offIngredientsImageUrl, offProductImageUrl: $offProductImageUrl, languageCode: $languageCode, schemaVersion: $schemaVersion)';
}
...
/// Create a copy of ProductCacheEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? barcode = null,Object? name = null,Object? createdAt = null,Object? lastRefreshedAt = null,Object? nextRefreshAt = null,Object? brand = freezed,Object? category = freezed,Object? categoriesHierarchy = freezed,Object? ingredients = freezed,Object? servingSize = freezed,Object? energyKcal = freezed,Object? proteinG = freezed,Object? carbsG = freezed,Object? fatG = freezed,Object? fiberG = freezed,Object? saltG = freezed,Object? nutriscoreGrade = freezed,Object? imageUrl = freezed,Object? offNutritionImageUrl = freezed,Object? offIngredientsImageUrl = freezed,Object? offProductImageUrl = freezed,Object? languageCode = null,Object? schemaVersion = null,}) {
...
class _ProductCacheEntry extends ProductCacheEntry {
  const _ProductCacheEntry({required this.barcode, required this.name, required this.createdAt, required this.lastRefreshedAt, required this.nextRefreshAt, @JsonKey(includeIfNull: false) this.brand, @JsonKey(includeIfNull: false) this.category, @JsonKey(includeIfNull: false) final  List<String>? categoriesHierarchy, @JsonKey(includeIfNull: false) this.ingredients, @JsonKey(includeIfNull: false) this.servingSize, @JsonKey(includeIfNull: false) this.energyKcal, @JsonKey(includeIfNull: false) this.proteinG, @JsonKey(includeIfNull: false) this.carbsG, @JsonKey(includeIfNull: false) this.fatG, @JsonKey(includeIfNull: false) this.fiberG, @JsonKey(includeIfNull: false) this.saltG, @JsonKey(includeIfNull: false) this.nutriscoreGrade, @JsonKey(includeIfNull: false) this.imageUrl, @JsonKey(includeIfNull: false) this.offNutritionImageUrl, @JsonKey(includeIfNull: false) this.offIngredientsImageUrl, @JsonKey(includeIfNull: false) this.offProductImageUrl, this.languageCode = 'en', this.schemaVersion = 1}): _categoriesHierarchy = categoriesHierarchy,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,barcode,name,createdAt,lastRefreshedAt,nextRefreshAt,brand,category,const DeepCollectionEquality().hash(_categoriesHierarchy),ingredients,servingSize,energyKcal,proteinG,carbsG,fatG,fiberG,saltG,nutriscoreGrade,imageUrl,offNutritionImageUrl,offIngredientsImageUrl,offProductImageUrl,languageCode,schemaVersion]);
