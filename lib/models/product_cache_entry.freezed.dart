...
@JsonKey(includeIfNull: false) double? get saltG;/// Additional nutrients beyond the six core fields.
///
...
/// when empty or null.
@JsonKey(includeIfNull: false) List<ProductNutrient>? get additionalNutrients;/// The Nutri-Score grade ('a' through 'e'), or 'not-applicable'.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,barcode,name,createdAt,lastRefreshedAt,nextRefreshAt,brand,category,const DeepCollectionEquality().hash(categoriesHierarchy),ingredients,servingSize,servingQuantity,quantity,productQuantity,energyKcal,proteinG,carbsG,fatG,fiberG,saltG,const DeepCollectionEquality().hash(additionalNutrients),nutriscoreGrade,imageUrl,offNutritionImageUrl,offIngredientsImageUrl,offProductImageUrl,languageCode,schemaVersion,usdaServingAmount,usdaServingUnit,usdaGramWeight]);

@override
String toString() {
  return 'ProductCacheEntry(barcode: $barcode, name: $name, createdAt: $createdAt, lastRefreshedAt: $lastRefreshedAt, nextRefreshAt: $nextRefreshAt, brand: $brand, category: $category, categoriesHierarchy: $categoriesHierarchy, ingredients: $ingredients, servingSize: $servingSize, servingQuantity: $servingQuantity, quantity: $quantity, productQuantity: $productQuantity, energyKcal: $energyKcal, proteinG: $proteinG, carbsG: $carbsG, fatG: $fatG, fiberG: $fiberG, saltG: $saltG, additionalNutrients: $additionalNutrients, nutriscoreGrade: $nutriscoreGrade, imageUrl: $imageUrl, offNutritionImageUrl: $offNutritionImageUrl, offIngredientsImageUrl: $offIngredientsImageUrl, offProductImageUrl: $offProductImageUrl, languageCode: $languageCode, schemaVersion: $schemaVersion, usdaServingAmount: $usdaServingAmount, usdaServingUnit: $usdaServingUnit, usdaGramWeight: $usdaGramWeight)';
}
...
@useResult
$Res call({
 String barcode, String name, int createdAt, int lastRefreshedAt, int nextRefreshAt,@JsonKey(includeIfNull: false) String? brand,@JsonKey(includeIfNull: false) String? category,@JsonKey(includeIfNull: false) List<String>? categoriesHierarchy,@JsonKey(includeIfNull: false) String? ingredients,@JsonKey(includeIfNull: false) String? servingSize,@JsonKey(includeIfNull: false) double? servingQuantity,@JsonKey(includeIfNull: false) String? quantity,@JsonKey(includeIfNull: false) double? productQuantity,@JsonKey(includeIfNull: false) double? energyKcal,@JsonKey(includeIfNull: false) double? proteinG,@JsonKey(includeIfNull: false) double? carbsG,@JsonKey(includeIfNull: false) double? fatG,@JsonKey(includeIfNull: false) double? fiberG,@JsonKey(includeIfNull: false) double? saltG,@JsonKey(includeIfNull: false) List<ProductNutrient>? additionalNutrients,@JsonKey(includeIfNull: false) String? nutriscoreGrade,@JsonKey(includeIfNull: false) String? imageUrl,@JsonKey(includeIfNull: false) String? offNutritionImageUrl,@JsonKey(includeIfNull: false) String? offIngredientsImageUrl,@JsonKey(includeIfNull: false) String? offProductImageUrl, String languageCode, int schemaVersion,@JsonKey(includeIfNull: false) double? usdaServingAmount,@JsonKey(includeIfNull: false) String? usdaServingUnit,@JsonKey(includeIfNull: false) double? usdaGramWeight
});
...
/// Create a copy of ProductCacheEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? barcode = null,Object? name = null,Object? createdAt = null,Object? lastRefreshedAt = null,Object? nextRefreshAt = null,Object? brand = freezed,Object? category = freezed,Object? categoriesHierarchy = freezed,Object? ingredients = freezed,Object? servingSize = freezed,Object? servingQuantity = freezed,Object? quantity = freezed,Object? productQuantity = freezed,Object? energyKcal = freezed,Object? proteinG = freezed,Object? carbsG = freezed,Object? fatG = freezed,Object? fiberG = freezed,Object? saltG = freezed,Object? additionalNutrients = freezed,Object? nutriscoreGrade = freezed,Object? imageUrl = freezed,Object? offNutritionImageUrl = freezed,Object? offIngredientsImageUrl = freezed,Object? offProductImageUrl = freezed,Object? languageCode = null,Object? schemaVersion = null,Object? usdaServingAmount = freezed,Object? usdaServingUnit = freezed,Object? usdaGramWeight = freezed,}) {
...
as double?,additionalNutrients: freezed == additionalNutrients ? _self.additionalNutrients : additionalNutrients // ignore: cast_nullable_to_non_nullable
as List<ProductNutrient>?,nutriscoreGrade: freezed == nutriscoreGrade ? _self.nutriscoreGrade : nutriscoreGrade // ignore: cast_nullable_to_non_nullable
...
as int,usdaServingAmount: freezed == usdaServingAmount ? _self.usdaServingAmount : usdaServingAmount // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String barcode,  String name,  int createdAt,  int lastRefreshedAt,  int nextRefreshAt, @JsonKey(includeIfNull: false)  String? brand, @JsonKey(includeIfNull: false)  String? category, @JsonKey(includeIfNull: false)  List<String>? categoriesHierarchy, @JsonKey(includeIfNull: false)  String? ingredients, @JsonKey(includeIfNull: false)  String? servingSize, @JsonKey(includeIfNull: false)  double? servingQuantity, @JsonKey(includeIfNull: false)  String? quantity, @JsonKey(includeIfNull: false)  double? productQuantity, @JsonKey(includeIfNull: false)  double? energyKcal, @JsonKey(includeIfNull: false)  double? proteinG, @JsonKey(includeIfNull: false)  double? carbsG, @JsonKey(includeIfNull: false)  double? fatG, @JsonKey(includeIfNull: false)  double? fiberG, @JsonKey(includeIfNull: false)  double? saltG, @JsonKey(includeIfNull: false)  List<ProductNutrient>? additionalNutrients, @JsonKey(includeIfNull: false)  String? nutriscoreGrade, @JsonKey(includeIfNull: false)  String? imageUrl, @JsonKey(includeIfNull: false)  String? offNutritionImageUrl, @JsonKey(includeIfNull: false)  String? offIngredientsImageUrl, @JsonKey(includeIfNull: false)  String? offProductImageUrl,  String languageCode,  int schemaVersion, @JsonKey(includeIfNull: false)  double? usdaServingAmount, @JsonKey(includeIfNull: false)  String? usdaServingUnit, @JsonKey(includeIfNull: false)  double? usdaGramWeight)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductCacheEntry() when $default != null:
return $default(_that.barcode,_that.name,_that.createdAt,_that.lastRefreshedAt,_that.nextRefreshAt,_that.brand,_that.category,_that.categoriesHierarchy,_that.ingredients,_that.servingSize,_that.servingQuantity,_that.quantity,_that.productQuantity,_that.energyKcal,_that.proteinG,_that.carbsG,_that.fatG,_that.fiberG,_that.saltG,_that.additionalNutrients,_that.nutriscoreGrade,_that.imageUrl,_that.offNutritionImageUrl,_that.offIngredientsImageUrl,_that.offProductImageUrl,_that.languageCode,_that.schemaVersion,_that.usdaServingAmount,_that.usdaServingUnit,_that.usdaGramWeight);case _:
  return orElse();
...
class _ProductCacheEntry extends ProductCacheEntry {
  const _ProductCacheEntry({required this.barcode, required this.name, required this.createdAt, required this.lastRefreshedAt, required this.nextRefreshAt, @JsonKey(includeIfNull: false) this.brand, @JsonKey(includeIfNull: false) this.category, @JsonKey(includeIfNull: false) final  List<String>? categoriesHierarchy, @JsonKey(includeIfNull: false) this.ingredients, @JsonKey(includeIfNull: false) this.servingSize, @JsonKey(includeIfNull: false) this.servingQuantity, @JsonKey(includeIfNull: false) this.quantity, @JsonKey(includeIfNull: false) this.productQuantity, @JsonKey(includeIfNull: false) this.energyKcal, @JsonKey(includeIfNull: false) this.proteinG, @JsonKey(includeIfNull: false) this.carbsG, @JsonKey(includeIfNull: false) this.fatG, @JsonKey(includeIfNull: false) this.fiberG, @JsonKey(includeIfNull: false) this.saltG, @JsonKey(includeIfNull: false) final  List<ProductNutrient>? additionalNutrients, @JsonKey(includeIfNull: false) this.nutriscoreGrade, @JsonKey(includeIfNull: false) this.imageUrl, @JsonKey(includeIfNull: false) this.offNutritionImageUrl, @JsonKey(includeIfNull: false) this.offIngredientsImageUrl, @JsonKey(includeIfNull: false) this.offProductImageUrl, this.languageCode = 'en', this.schemaVersion = 1, @JsonKey(includeIfNull: false) this.usdaServingAmount, @JsonKey(includeIfNull: false) this.usdaServingUnit, @JsonKey(includeIfNull: false) this.usdaGramWeight}): _categoriesHierarchy = categoriesHierarchy,_additionalNutrients = additionalNutrients,super._();
...
/// trip the extra nutrients across devices. Omitted from the document
/// when empty or null.
@override@JsonKey(includeIfNull: false) List<ProductNutrient>? get additionalNutrients {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,barcode,name,createdAt,lastRefreshedAt,nextRefreshAt,brand,category,const DeepCollectionEquality().hash(_categoriesHierarchy),ingredients,servingSize,servingQuantity,quantity,productQuantity,energyKcal,proteinG,carbsG,fatG,fiberG,saltG,const DeepCollectionEquality().hash(_additionalNutrients),nutriscoreGrade,imageUrl,offNutritionImageUrl,offIngredientsImageUrl,offProductImageUrl,languageCode,schemaVersion,usdaServingAmount,usdaServingUnit,usdaGramWeight]);
...
as double?,fiberG: freezed == fiberG ? _self.fiberG : fiberG // ignore: cast_nullable_to_non_nullable
as double?,saltG: freezed == saltG ? _self.saltG : saltG // ignore: cast_nullable_to_non_nullable
as double?,additionalNutrients: freezed == additionalNutrients ? _self._additionalNutrients : additionalNutrients // ignore: cast_nullable_to_non_nullable
as List<ProductNutrient>?,nutriscoreGrade: freezed == nutriscoreGrade ? _self.nutriscoreGrade : nutriscoreGrade // ignore: cast_nullable_to_non_nullable
as String?,imageUrl: freezed == imageUrl ? _self.imageUrl : imageUrl // ignore: cast_nullable_to_non_nullable
as String?,offNutritionImageUrl: freezed == offNutritionImageUrl ? _self.offNutritionImageUrl : offNutritionImageUrl // ignore: cast_nullable_to_non_nullable
as String?,offIngredientsImageUrl: freezed == offIngredientsImageUrl ? _self.offIngredientsImageUrl : offIngredientsImageUrl // ignore: cast_nullable_to_non_nullable
