...
final FutureProviderFamily<List<Price>, String> priceHistoryProvider =
    FutureProvider.autoDispose.family<List<Price>, String>(
      (ref, barcode) {
...
final FutureProviderFamily<Price?, String> latestPriceProvider = FutureProvider
    .autoDispose
    .family<Price?, String>(
      (ref, barcode) {
