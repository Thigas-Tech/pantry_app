  ...
  Future<String> generateCsv({required int inventoryId}) async {
    ...
    for (final row in rows) {
      ...
      final values = <String>[
        ...
        _escapeField(row['nutrition_image_path']),
        _escapeField(row['ingredients_image_path']),
        _escapeField(row['product_image_path']),
        _escapeField(row['submission_status']),
      ...
      try {
        ...
        final product = Product(
          ...
          source: (map['Source'] ?? '').trim().isNotEmpty
              ? map['Source']!.trim()
              : 'manual',
          nutritionImagePath: map['Nutrition Table Photo'].emptyAsNull,
          ingredientsImagePath: map['Ingredients List Photo'].emptyAsNull,
          productImagePath: map['Product Photo'].emptyAsNull,
