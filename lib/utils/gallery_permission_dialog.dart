...
/// Shows a dialog explaining that gallery access is required and offering to
/// open the system settings.
///
/// [openSettings] is injectable for tests and defaults to
/// [openAppSettings]. Returns when the dialog is dismissed.
Future<void> showGalleryPermissionDialog(
  ...
  final shouldOpenSettings = await showDialog<bool>(
    ...
    builder: (ctx) => AlertDialog(
      title: Text(l10n.galleryPermissionDeniedTitle),
      content: Text(l10n.galleryPermissionDeniedBody),
      actions: [
        TextButton(
